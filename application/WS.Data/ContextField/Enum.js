/* global define */
define('WS.Data/ContextField/Enum', [
    ...
    * @author Мальцев А.А.
    */
   var ContextFieldEnum = ContextFieldBase.extend(/** @lends WS.Data/ContextField/Enum.prototype*/{
      '[WS.Data/ContextField/Enum]': true,

      name: 'ControlsFieldTypeEnum',

      /**
       * Возвращает значение поля контекста по пути.
       * @param {WS.Data/Type/Enum} value Поле контекста
