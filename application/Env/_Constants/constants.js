define('Env/_Constants/constants', [
    'require',
    'exports'
], function (require, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });    /// <amd-module name="Env/_Constants/constants" />
    /// <amd-module name="Env/_Constants/constants" />
    var now = +new Date();
    ...
    var constants = /** @lends Core/_Util/constants.prototype */
    {
         ...
         */
        compat: (typeof window === 'undefined' || window && window.location.href.indexOf('withoutLayout') === -1) && // @ts-ignore
