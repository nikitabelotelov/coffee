define('Env/_Config/UserConfigOld', [
    'require',
    'exports',
    'Env/Constants',
    'Env/_Config/AbstractConfigOld',
    'Core/Deferred'
], function (require, exports, Constants_1, AbstractConfigOld_1, Deferred) {
    'use strict';
    ...
    * Класс не рекомендуется использовать в VDOM. Лучше использовать сервис параметров.
    */
    var UserConfig = AbstractConfigOld_1.default.extend(/** @lends Core/UserConfig.prototype */
    {
        /**
        ...
        _isConfigSupport: function () {
            return Constants_1.constants.isNodePlatform || Constants_1.constants.userConfigSupport;
        },
        /**
