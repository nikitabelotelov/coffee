/// <amd-module name="Env/_Config/AbstractConfigOld" />
// @ts-ignore
import * as Abstract from 'Core/Abstract';
// @ts-ignore
import * as Deferred from 'Core/Deferred';
import { SessionStorage } from 'Browser/Storage';
import constants from 'Env/_Constants/constants';
// @ts-ignore
import { SbisService } from 'optional!Types/source';
 ...
 * @author Бегунов А.В.
 */
export default Abstract.extend(/** @lends Core/AbstractConfig.prototype */{
   /**
   ...
   _processingParam: function(operation, name, value) {
      if (!constants.isBrowserPlatform || !name) {
         return;
      }
