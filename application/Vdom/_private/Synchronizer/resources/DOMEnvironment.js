...
define('Vdom/_private/Synchronizer/resources/DOMEnvironment', [
    ...
    'View/Logger'
], function (require, exports, coreDebug, constants, IoC, findIndex, isNewEnvironment, runDelayedRebuild_1, VdomMarkup_1, Hooks, SyntheticEvent_1, TabIndex, Expressions_1, Utils_1, Markup_1, detection, Environment_1, SwipeController, Logger) {
    'use strict';
     ...
     * Задача в разработку 01.06.2017 Поднять юнит тестирование VDOM Обеспечить покрытие тестами и прозрачность кода файлов…
     */
    var assert = coreDebug.checkAssertion, TAB_KEY = 9,
    ...
    function detectStrangeElement(element) {
        ...
        // в IE обработчик срабатывает и в том случае, когда фокус переходит прямо на body, нужно
        // не обращать на это внимание
        return element.parentElement === document.body && !element.firstChild || detection.isIE && element === document.body;
    }
    proto._handleFocusEvent = function handleFocusEvent(e) {
        ...
        if (this._rootDOMNode && Expressions_1.Focus.closest(e.target, this._rootDOMNode) && !detectStrangeElement(e.target)) {
    ...
    proto._shouldUseClickByTap = function shouldUseClickByTap() {
        ...
        return constants.browser.retailOffline || constants.compatibility.touch && constants.browser.chrome && navigator && navigator.userAgent.indexOf('Windows') > -1;
    };
