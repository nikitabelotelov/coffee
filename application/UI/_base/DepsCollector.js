...
define('UI/_base/DepsCollector', [
    ...
    function mergePacks(result, addedPackages) {
        for (var pack in addedPackages) {
            if (addedPackages.hasOwnProperty(pack)) {
                if (result[pack] === undefined) {
                    result[pack] = {};
                }
                for (var key in addedPackages[pack]) {
    ...
    function () {
         ...
         */
        function DepsCollector(modDeps, modInfo, bundlesRoute, themesActive) {
            this.modDeps = modDeps;
            this.modInfo = modInfo;
            this.bundlesRoute = bundlesRoute;
            this.themesActive = themesActive;
        }
        DepsCollector.prototype.collectDependencies = function (deps) {
            var files = {
                js: [],
                css: {
                    themedCss: [],
