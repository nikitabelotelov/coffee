define('Browser/_Event/Server/native/SockjsEmulator', [
    'require',
    'exports',
    'Browser/_Event/Server/_class/Events'
], function (require, exports, EventClass) {
    'use strict';    /**
    ...
    function () {
        ...
        SockJSTransport.prototype.send = function (data) {
            ...
            var text = data.replace(/\u0000/gm, '\\u0000')    /*.replace(/\b/gm, "\\b")*/.replace(/\n/gm, '\\n').replace(/\f/gm, '\\f').replace(/\r/gm, '\\r').replace(/\t/gm, '\\t');    /* eslint-enable no-control-regex */
