define('Browser/_Event/Server/native/_IndexedDB/Writer', [
    'require',
    'exports'
     ...
     * @class Browser/_Event/Server/native/_IndexedDB/Writer
     */
    /**
     * Класс, который записывает Stomp данные в IndexDB
     * @class Browser/_Event/Server/native/_IndexedDB/Writer
    ...
    function () {
        ...
        function Writer(db, storeName, adapter) {
            ...
            this.garbageCollection = this.garbageCollection.bind(this);    // @ts-ignore
            // @ts-ignore
        ...
        Writer.prototype.write = function () {
            ...
            try {
                this.db.transaction(this.storeName, 'readwrite').objectStore(this.storeName).add(data);
            } catch (e) {
        ...
        Writer.prototype.garbageCollection = function () {
            var _this = this;
            try {
                var store_1 = this.db.transaction(this.storeName, 'readwrite').objectStore(this.storeName);
