define('Browser/_Event/Server/native/_IndexedDB/AdapterEvent', [
    'require',
    'exports'
    ...
    function () {
        ...
        AdapterEvent.prototype.prepare = function (channelName, eventName, body) {
            var _a;    /* На ipad performance.now() не подходит для ключа KEY_UNIQ.
            ...
            var data = (_a = {
                ...
                eventName: eventName,
                body: body
            }, _a[KEY_TIMESTAMP] = Date.now(), _a[KEY_UNIQ] = Math.random() * 1000000, _a);
            return data;
        };
