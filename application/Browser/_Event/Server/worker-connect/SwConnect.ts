/// <amd-module name="Browser/_Event/Server/worker-connect/SwConnect" />

import CONST = require('Browser/_Event/Server/worker-connect/Constants');
import PageMessage = require('Browser/_Event/Server/worker-connect/messages/Page');
import SwMessage = require('Browser/_Event/Server/worker-connect/messages/Sw');
import CONST_CLASS = require('Browser/_Event/Server/_class/Constants');

module SwConnect {
    /**
     * TODO нужно разобраться с onready/ondisconnect для канализированных событий
     * @class Browser/_Event/Server/Connect
     */
