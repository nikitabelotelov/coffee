...
define('Browser/_Event/Server/worker-connect/SwConnect', [
    'require',
    'exports',
    'Browser/_Event/Server/worker-connect/Constants',
    'Browser/_Event/Server/worker-connect/messages/Page'
], function (require, exports, CONST, PageMessage) {
    'use strict';
    var SwConnect;
    (function (SwConnect) {
        /**
