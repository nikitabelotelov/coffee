define('Browser/_Event/Server/worker-connect/WorkerBuilder', [
    'require',
    'exports',
    'tslib',
    'Core/Deferred',
    'Browser/_Event/Server/worker-connect/SwConnect'
], function (require, exports, tslib_1, Deferred, SwConnect) {
    /// <amd-module name="Browser/_Event/Server/worker-connect/WorkerBuilder" />
    /**
    ...
    var ClientMessageHandshake = /** @class */
    function (_super) {
    ...
    }(ClientMessage);    ///endregion
    ///endregion
    var SwHandeshake = /** @class */
    function () {
    ...
    function () {
        ...
        SwInstaller.getWorkerContainer = function (workerType) {
            ...
            case SwInstaller.SHARED_WORKER:
                ...
                break;    /*case SwInstaller.SERVICE_WORKER:
