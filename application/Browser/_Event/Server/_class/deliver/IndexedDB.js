define('Browser/_Event/Server/_class/deliver/IndexedDB', [
    'require',
    'exports',
    'Browser/_Event/Server/native/_IndexedDB'
], function (require, exports, _IndexedDB_1) {
    'use strict';
    ...
    function () {
        function IndexedDB(notifier, connect) {
            ...
            this.tick = this.tick.bind(this);    // @ts-ignore
            // @ts-ignore
        ...
        IndexedDB.prototype.tick = function () {
            ...
            */
            ...
            this.reader.query(last).then(function (events) {
