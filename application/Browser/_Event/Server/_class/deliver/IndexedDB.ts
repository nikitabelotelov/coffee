/// <amd-module name="Browser/_Event/Server/_class/deliver/IndexedDB" />
// @ts-ignore
import Deferred = require('Core/Deferred');
import { Notifier } from 'Browser/_Event/Server/_class/Notifier';
import { SEB } from "../../interfaces";
import { Connector, Reader, Writer, AdapterEvent, IMessage } from 'Browser/_Event/Server/native/_IndexedDB';
