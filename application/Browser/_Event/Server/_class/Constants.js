define('Browser/_Event/Server/_class/Constants', [
    'require',
    'exports'
], function (require, exports) {
    'use strict';    /// <amd-module name="Browser/_Event/Server/_class/Constants" />
    /// <amd-module name="Browser/_Event/Server/_class/Constants" />
    var CONST;
    (function (CONST) {
        var CHANNEL_SCOPE;
