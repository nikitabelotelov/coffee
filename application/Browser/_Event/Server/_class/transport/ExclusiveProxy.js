define('Browser/_Event/Server/_class/transport/ExclusiveProxy', [
    'require',
    'exports',
    'Core/Deferred',
    'Browser/Storage',
    'Browser/_Event/Server/_class/Constants',
    'Browser/_Event/Server/_class/DeviceEnv',
    'Browser/_Event/Server/_class/transport/TransportChooser',
    'Browser/_Event/Server/_class/Subscribe',
    'Browser/_Event/Server/DebugUtils'
], function (require, exports, Deferred, Storage_1, CONST, DeviceEnv_1, TransportChooser_1, Subscribe_1, DebugUtils) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    var SubscribeExclusiveError = /** @class */
    function () {
    ...
    function () {
        ...
        ExclusiveProxy.init = function (isExclusive, onCloseHandler, watcher) {
            ...
            DeviceEnv_1.DeviceEnv.getOptions().addCallback(function (options) {
                ...
                try {
                    ...
                    if (window && Storage_1.LocalStorageNative.getItem('shared-bus-debug') === 'true') {
        ...
        ExclusiveProxy.prototype.subscribe = function (subscribe) {
            if (subscribe.getDeliveryType() !== CONST.DELIVERY_COMMON && !this.isExclusive) {
