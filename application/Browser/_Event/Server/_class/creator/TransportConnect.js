define('Browser/_Event/Server/_class/creator/TransportConnect', [
    ...
    function () {
        ...
        TransportConnect.prototype.getWebSocket = function (url, isHeartbit) {
            if (isHeartbit === void 0) {
                isHeartbit = true;
            }
            return new Promise(function (resolve, reject) {
                // @ts-ignore
                require(['Browser/_Event/Server/native/SockjsEmulator'], function (SockJSTransport) {
                    try {
        ...
        TransportConnect.prototype.requireStomp = function () {
            return new Promise(function (resolve) {
                // @ts-ignore
                require(['Browser/_Event/Server/resources/stomp'], function () {
                    resolve();
                });
            });
        };    /**
        ...
        TransportConnect.prototype.requireSockjs = function () {
            return new Promise(function (resolve, reject) {
                // @ts-ignore
                require([
                    'Browser/_Event/Server/resources/stomp',
                    'Browser/_Event/Server/resources/sockjs-1.0.3'
                ], function (_, sockjs) {
                    if (!sockjs) {
                        return reject('Can\'t load Browser/_Event/Server/resources/sockjs-1.0.3');
                    }
                    resolve(sockjs);
                });
            });
        ...
        TransportConnect.prototype.byWebSocket = function (url, isHeartbit) {
            var _this = this;
            return this.requireStomp().then(function () {
                return _this.getWebSocket(url, isHeartbit);
            });
        };    /**
         * @param {string} url Строка подключения
         * @param {boolean} isHeartbit Првоерять ли heartbit от сервера.
        ...
        TransportConnect.prototype.initStomp = function (webSocket) {
            return new Promise(function (resolve, reject) {
                ...
                stomp.connect(TransportConnect.LOGIN, TransportConnect.PASSWORD, function () {
                    resolve(stomp);
                }, function (data) {
                    reject(data);
                });
