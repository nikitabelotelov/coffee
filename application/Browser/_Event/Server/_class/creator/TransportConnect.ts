/// <amd-module name="Browser/_Event/Server/_class/creator/TransportConnect" />
...
export class TransportConnect {
    ...
    private getWebSocket(url, isHeartbit = true): Promise<WebSocket> {
        return new Promise<WebSocket>((resolve, reject) => {
            // @ts-ignore
            require(["Browser/_Event/Server/native/SockjsEmulator"], (SockJSTransport) => {
                try {
    ...
    private requireStomp(): Promise<undefined> {
        return new Promise((resolve) => {
            // @ts-ignore
            require(["Browser/_Event/Server/resources/stomp"], () => {
                resolve();
            });
        });
    }
