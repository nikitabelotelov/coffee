define('Browser/_Event/Server/_class/logger/ConfirmLogger', [
    'require',
    'exports'
], function (require, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });    /// <amd-module name="Browser/_Event/Server/_class/logger/ConfirmLogger" />
                                                                      /**
     ...
     */
    /// <amd-module name="Browser/_Event/Server/_class/logger/ConfirmLogger" />
    /**
     * TODO удалить метка #УдлБ
     * Логгер подтверждения доставки сообщений
     * @class Lib.ServerEventBus.class.logger.ConfirmLogger
