define('Browser/_Storage/Session', [
    'require',
    'exports',
    'Core/UserInfo',
    'Env/Env',
...
], function (require, exports, UserInfo, Env_1, Constants_1, _storage_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    var saveSSTimeout;
    var storage = _storage_1.getSession();
    ...
    function getSessionObject() {
         ...
         */
        if (!Constants_1.constants.isBrowserPlatform && Constants_1.constants.isBuildOnServer) {
            // @ts-ignore
    ...
    if (Constants_1.constants.isBrowserPlatform) {
        var event = Env_1.detection.firefox ? 'beforeunload' : 'unload';
