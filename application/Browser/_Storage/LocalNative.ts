/// <amd-module name="Browser/_Storage/LocalNative" />
// @ts-ignore
import * as UserInfo from 'Core/UserInfo';
import { IoC } from 'Env/Env';
import { constants }  from 'Env/Constants';
// @ts-ignore
import * as format from 'Core/helpers/String/format';
// @ts-ignore
import * as i18n from 'Core/i18n';
import { getLocal } from 'Browser/_Storage/_storage';
import { Bus as EventBus } from 'Env/Event';

///region const
const S3SU_KEY = "__s3su";
...
const MAXIMUM_ITEM_SIZE = 1024 * 512;
const ERROR_FORMAT = i18n.rk(
 ...
 * @public
 */
let LocalStorageNative = /** @lends Core/LocalStorageNative.prototype*/{
    /**
     ...
     */
    setItem: function (key, data): boolean {
...
export default LocalStorageNative;
