/// <amd-module name="Browser/_Storage/NativeGetter" />
import { Bus as EventBus } from 'Env/Event';
import LocalStorageNative from "Browser/_Storage/LocalNative";
import * as utils from "Browser/_Storage/utils";
...
const FIX_EVENT_KEY = utils.prefix.add("ie-fix-event", SYSTEM_STORAGE_NAME);
...
function storageSystemHandler(key, value, oldValue) {
    let eventKey = utils.prefix.remove(key, SYSTEM_STORAGE_NAME);
