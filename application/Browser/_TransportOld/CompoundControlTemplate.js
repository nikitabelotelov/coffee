define('Browser/_TransportOld/CompoundControlTemplate', [
    ...
    CompoundControlTemplate = Template.extend({
        ...
        getConfig: function () {
            var templateClass = this._options.template, proto = templateClass.prototype, result = {}, dimensions = templateClass.dimensions || templateClass.prototype.dimensions || {}; //Для наследования дименшены могут объявить на прототипе
