define('Browser/_Transport/RPCJSON', [
    'require',
    'exports',
    'Core/core-extend',
    'Env/Constants',
    ...
    'Browser/_Transport/RPC/request',
    'Browser/_Transport/RPC/fallback',
    'Browser/_Transport/RPC/ErrorCreator',
    'Browser/_Transport/XHR'
], function (require, exports, coreExtend, Constants_1, Env_1, RPCBody, Headers_1, request_1, fallback_1, ErrorCreator) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    var logger = Env_1.IoC.resolve('ILogger');
    function deprecatedLog(oldName, newName) {
        newName = newName ? ', use "' + newName + '"' : '';
        logger.log('Browser/_Transport/RPCJSON', 'Method "' + oldName + '" is deprecated and will be removed' + newName);
    }
    ...
    */
    var RPCJSON = coreExtend({}, /** @lends Transport/RPCJSON.prototype */
    {
        ...
        callMethod: function (method, args, recent) {
            ...
            // Необходимо чтобы не сломать abort последнего запроса
            var callFunction = this._options.fallback ? fallback_1.default : request_1.default;
         ...
         */
        abort: function () {
            logger.log('Browser/_Transport/RPCJSON', 'Метод "abort" обрывает только последний созданный запрос. Если вам необходима эта логика используйде Core/Deferred#cancel');
        ...
        __createTransport: function (method) {
            return Env_1.IoC.resolve('ITransport', {
                url: this.__getServiceAddress(),
                method: method,
                dataType: 'json',
        ...
        __getServiceAddress: function (params) {
            var service = this._options.serviceUrl || Constants_1.constants.defaultServiceUrl;
            service += service.indexOf('?') > -1 ? '&' : '?';
            var xVersion = 'x_version=' + Constants_1.constants.buildnumber;
        ...
        _setHeaders: function (req, httpMethod, recent) {
            deprecatedLog('_setHeaders', 'Browser/_Transport/RPC/Headers');    // @ts-ignore
            // @ts-ignore
            Object.assign(req.reqHeaders, new Headers_1.default({
                recent: recent,
                httpMethod: httpMethod,
                fallback: this._options.fallback,
                asyncInvoke: this._options.asyncInvoke
    ...
    RPCJSON.jsonRpcPreparePacket = function (method, params, id) {
        deprecatedLog('jsonRpcPreparePacket', 'Browser/_Transport/RPC/Body" or "Browser/_Transport/RPC/Headers');
        return {
            reqUrl: RPCBody.getURL(method, params, id),
            reqBody: RPCBody.getBody(method, params, id),
            reqHeaders: Headers_1.default.getForMethod(method)
        };
    };    /**
     ...
     * @deprecated
     */
    RPCJSON.getEmptyRpcResponse = deprecatedWrapper('getEmptyRpcResponse', 'Browser/_Transport/RPC/Body#getEmptyResponse', RPCBody.getEmptyResponse);    /**
     * @param {Error} error
     ...
     * @deprecated
     */
    RPCJSON.handleHTTPError = deprecatedWrapper('handleHTTPError', 'Browser/_Transport/RPC/ErrorNotifier#HTTP', ErrorCreator.fromHTTP);    /**
     ...
     * @deprecated
     */
    RPCJSON.handleRPCError = deprecatedWrapper('handleRPCError', 'Browser/_Transport/RPC/ErrorNotifier#RPC', ErrorCreator.fromRPC);    /// endregion deprecated static
    /// endregion deprecated static
    exports.default = RPCJSON;
});