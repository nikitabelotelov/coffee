define('Browser/_Transport/RPC/fallback', [
    'require',
    'exports',
    'Core/Deferred'
    ...
    var fallback = function (_a) {
        ...
        var deferred = new Deferred();    // @ts-ignore
        // @ts-ignore
        require(['Env/ServerEvent/Bus'], function (ServerEventBus) {
            var getChannel = function () {
                return ServerEventBus.serverChannel(FALLBACK_EVENT_NAME);
            };
            getChannel().once('onReady', function () {
                ...
                var eventListener = getEventListener(ctx);    // @ts-ignore
                // @ts-ignore
