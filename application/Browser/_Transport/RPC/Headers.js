define('Browser/_Transport/RPC/Headers', [
    'require',
    'exports',
    'Env/Event',
    'Core/UserInfo',
    'Core/i18n',
    'Core/helpers/i18n/transliterate',
    'Core/base64',
    'Core/helpers/createGUID'
], function (require, exports, Event_1, userInfo, i18n, transliterate, base64, createGUID) {
    'use strict';
     ...
     * Необходимо чтобы принимать решение о чтении с реплик БД
     */
    var _cacheHeaders = {};    // @ts-ignore
    // @ts-ignore
    Event_1.Bus.channel('Transport').subscribe('onResponseSuccess', function (event, xhr, def, url) {
