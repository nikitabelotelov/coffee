define('Browser/_Transport/fetch/Errors', [
    'require',
    'exports',
    'tslib',
    'Core/i18n',
    'Core/core-classicExtend'
], function (require, exports, tslib_1, i18n, classicExtend) {
    'use strict';
    ...
    exports.Transport = Transport;    // ts-extend Error, Array, Map некоректно отрабатывают без вызова setPrototypeOf почле super
    ...
    function (_super) {
        ...
        function HTTP(cfg) {
            ...
            var _this = this;
            var config;    // для обратной совместимсти с Browser/_Transport/HTTPError
            // для обратной совместимсти с Browser/_Transport/HTTPError
            if (typeof cfg == 'string') {
                var status = args[0], url = args[1], payload = args[2], details = args[3];
                config = {
                    message: cfg,
                    httpError: status,
                    url: url,
            ...
            _this.xhr = config.xhr;    // для обратной совместимсти с Browser/_Transport/HTTPError
            // для обратной совместимсти с Browser/_Transport/HTTPError
    ...
    exports.HTTP = HTTP;    // tslint:disable max-classes-per-file
                            /**
    ...
    function (_super) {
        ...
        function Connection(url) {
            ...
            _this.name = 'ConnectionError';    // для обратной совместимсти с Browser/_Transport/HTTPError#offlineModeError
