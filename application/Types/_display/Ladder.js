...
define('Types/_display/Ladder', [
    ...
    'Types/util',
    'Types/shim'
], function (require, exports, tslib_1, Collection_1, entity_1, collection_1, util_1, shim_1) {
    'use strict';
    ...
    function (_super) {
        ...
        Ladder.prototype._onCollectionChange = function (event, action, newItems, newItemsIndex, oldItems, oldItemsIndex) {
            ...
            case collection_1.IObservable.ACTION_REMOVE:
                ...
                break;
            case collection_1.IObservable.ACTION_CHANGE:
