 ...
 * @author Мальцев А.А.
 */
define('Types/_collection/EventRaisingMixin', [
    'require',
    'exports',
    ...
    var EventRaisingMixin = /** @lends Types/_entity/EventRaisingMixin.prototype */
    {
        ...
        _startUpdateSession: function () {
            ...
            return enumerableComparator_1.default.startSession(this, this._sessionItemContentsGetter);
        },
        /**
        ...
        _finishUpdateSession: function (session, analize) {
            ...
            enumerableComparator_1.default.finishSession(session, this, this._sessionItemContentsGetter);
            if (analize) {
        ...
        _analizeUpdateSession: function (session) {
            ...
            enumerableComparator_1.default.analizeSession(session, this, function (action, changes) {
