...
define('Types/_collection/enumerableComparator', [
...
], function (require, exports, IObservable_1) {
    'use strict';
                ...
                while (startFrom !== -1) {
                    ...
                    if (changes.newItems.length || changes.oldItems.length) {
                        ...
                        if (callback) {
                            ...
                            switch (groupName) {
                            case 'added':
                                groupAction = IObservable_1.default.ACTION_ADD;
                                break;
                            case 'removed':
                                groupAction = IObservable_1.default.ACTION_REMOVE;
                                break;
                            case 'replaced':
                                groupAction = IObservable_1.default.ACTION_REPLACE;
                                break;
                            case 'moved':
                                groupAction = IObservable_1.default.ACTION_MOVE;
                                break;
                            }
    ...
    exports.default = enumerableComparator;
});