...
define('Types/_formatter/date', [
    ...
    function withLeadZeroes(value, count) {
        ...
        var restCount = count - absValue.length;
        var sign = value >= 0 ? '' : '-';
        return sign + (String(Math.pow(10, Math.max(0, restCount))).substr(1) + absValue);
    }    /**
    ...
    function getQuarterRoman(date) {
        return numberRoman_1.default(getQuarter(date));
    }    /**
    ...
    function getQuarterRomanMin(date) {
        return locale.config.minQuarter.replace('$digit$s$', getQuarterRoman(date));
    }    /**
    ...
    function getQuarterRomanShort(date) {
        return locale.config.shortQuarter.replace('$digit$s$', getQuarterRoman(date));
    }    /**
    ...
    function getQuarterRomanLong(date) {
        return locale.config.longQuarter.replace('$digit$s$', getQuarterRoman(date));
    }    /**
    ...
    function getHalfYearRoman(date) {
        return numberRoman_1.default(getHalfYear(date));
    }    /**
    ...
    function getHalfYearRomanMin(date) {
        return locale.config.minHalfYear.replace('$digit$s$', getHalfYearRoman(date));
    }    /**
    ...
    function getHalfYearRomanLong(date) {
        return locale.config.longHalfYear.replace('$digit$s$', getHalfYearRoman(date));
    }    /**
