define('Types/_entity/date/fromSql', [
    'require',
    'exports',
    'Core/constants'
    ...
    function fromSQL(dateTime, defaultTimeZone) {
        var dateSep = dateTime.indexOf('-'), timeSep = dateTime.indexOf(':'), millisecSep = dateTime.indexOf('.'), tz = dateTime.match(SQL_FORMAT), tzSep = tz && tz.index + tz[1].length || -1, retval = new Date(), ms = null, msStr, y, m, d;
