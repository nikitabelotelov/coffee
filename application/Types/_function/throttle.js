define('Types/_function/throttle', [
    'require',
    'exports'
], function (require, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });    /// <amd-module name="Types/_function/throttle" />
                                                                      /**
     *
    ...
    function throttle(original, delay, last) {
        ...
        return function () {
            ...
            if (state) {
                ...
                next = original.bind.apply(original, [this].concat(args));
            }
        };
    }
