...
//@ts-ignore
import compatibility = require('Core/compatibility');
//@ts-ignore
 ...
 * @public
 */
const constants = /** @lends Core/constants.prototype */{
   /**
   ...
   (typeof window === 'undefined' || (<ExtWindow>window).wsConfig.compatible !== false),
