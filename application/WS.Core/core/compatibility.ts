...
export = {
   ...
   fullScreen: document && (
      ...
      (<ExtHTMLDivElement>div).mozRequestFullScreen !== undefined || // Firefox
      (<ExtHTMLDivElement>div).webkitRequestFullscreen !== undefined // Chrome
   ),
    ...
    */
   wheel: document && (
      (div.onwheel !== undefined || (<ExtDocument>document).documentMode >= 9) ? 'wheel' // Firefox 17+, IE 9+
         : (<ExtHTMLDivElement>div).onmousewheel !== undefined ? 'mousewheel' // Chrome, Opera, IE 8-
