define("Lib/ServerEvent/_class/transport/LocalSlaveTransport", ["require", "exports", "tslib", "Lib/Tab/Message", "Lib/Storage/LocalStorage", "Lib/ServerEvent/_class/transport/Constants", "Lib/ServerEvent/_class/transport/Transport", "Lib/ServerEvent/_class/SubscribeContainer", "Lib/ServerEvent/_class/Events"], function (require, exports, tslib_1, TabMessage, LocalStorage, CONST, Transport_1, SubscribeContainer_1, Events_1) {
    "use strict";
    ...
    var LocalSlaveTransport = /** @class */ (function (_super) {
        ...
        LocalSlaveTransport.prototype.destructor = function (message, isFireCallback) {
            ...
            if (isFireCallback) {
                var event_1 = message ? Events_1.create(message) : undefined;
                callback(event_1);
            }
        };
        /**
