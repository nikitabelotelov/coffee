...
define('View/Executor/_Utils/Vdom', [
...
], function (require, exports, Request, Logger, Inferno, Expressions_1, OptionsResolver_1, Common_1) {
    'use strict';
    ...
    function getStateReadyOrCall(stateVar, control, vnode, serializer) {
        ...
        try {
            res = data ? control._beforeMount(vnode.controlProperties, ctx, data) : control._beforeMount(vnode.controlProperties, ctx);
        } catch (error) {
