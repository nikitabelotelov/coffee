...
define('View/Executor/GeneratorCompatible', [
    ...
    'View/Executor/Utils'
], function (require, exports, randomId, Context, confStorage, ParserUtilities, coreInitializer, ContextBinder, IoC, cConstants, shallowClone, Serializer, Logger, Request, Markup_1, Expressions_1, Utils_1) {
    'use strict';
    ...
    function buildForNewControl(scope, cnstr, decOptions) {
        ...
        result = inst._template ? inst.render(undefined, { attributes: decOptions }) : '';    // Добавлено, чтобы новый контрол (в частности, Controls/Decorator/Markup) в старом окружении не терял атрибуты из шаблона.
