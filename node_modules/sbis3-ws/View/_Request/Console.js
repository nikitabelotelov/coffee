define("View/_Request/Console", ["require", "exports", "Core/constants"], function (require, exports, constants) {
    "use strict";
    ...
    var Console = /** @class */ (function () {
        ...
        Console.prototype.info = function () {
            if (isAllowedLog(this.__logLevel, LogLevel.info) &&
        ...
        Console.prototype.error = function () {
            if (!isAllowedLog(this.__logLevel, LogLevel.error) ||
