define("View/Executor/_Markup/Generator", ["require", "exports", "Env/Env", "View/Logger", "View/Executor/Utils", "View/Executor/Expressions"], function (require, exports, Env_1, Logger, Utils_1, Expressions_1) {
    "use strict";
            ...
            if (name === null) {
                ...
                if (type === 'wsControl') {
                    if (Logger.getLoggerStatus() || Utils_1.Common.isCompat()) {
                        res = Env_1.coreDebug.methodExecutionTime(this.createWsControl, this, [name, data, attrs, context, deps]);
                    }
                    else {
                ...
                if (type === 'template') {
                    if (Logger.getLoggerStatus() || Utils_1.Common.isCompat()) {
                        res = Env_1.coreDebug.methodExecutionTime(this.createTemplate, this, [name, data, attrs, context, deps, config]);
                    }
                    else {
                ...
                if (type === 'controller') {
                    if (Logger.getLoggerStatus() || Utils_1.Common.isCompat()) {
                        res = Env_1.coreDebug.methodExecutionTime(this.createController, this, [name, data, attrs, context, deps]);
                    }
                    else {
                ...
                if (type === 'resolver') {
                    ...
                    if (Logger.getLoggerStatus() || Utils_1.Common.isCompat()) {
                        res = Env_1.coreDebug.methodExecutionTime(this.resolver, this, [name, data, attrs, context, deps, includedTemplates, config, defCollection]);
                    }
                    else {
                ...
                if (res !== undefined) {
                    ...
                    if (typeof name === 'undefined') {
                        Env_1.IoC.resolve('ILogger').error('Undefined component error', 'Попытка использовать компонент/шаблон, ' +
