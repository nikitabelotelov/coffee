...
define("View/Executor/TClosure", ["require", "exports", "Core/Serializer", "Core/i18n", "Env/Env", "View/config", "View/Executor/Markup", "View/Executor/Expressions", "View/Executor/Utils"], function (require, exports, Serializer, i18n, Env_1, config, Markup_1, Expressions_1, Utils_1) {
    "use strict";
    var decorators;
    ...
    function addToString() {
        Env_1.IoC.resolve("ILogger").error("Использование контентной опции компонента или шаблона в качестве строки", "Необходимо использовать контентные опции с помощью конструкции ws:partial или " +
