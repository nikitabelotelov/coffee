...
define("View/Executor/TClosure", ["require", "exports", "Core/Serializer", "Core/i18n", "Core/IoC", "Core/constants", "View/config", "View/Executor/Markup", "View/Executor/Expressions", "View/Executor/Utils"], function (require, exports, Serializer, i18n, IoC, cConstants, config, Markup_1, Expressions_1, Utils_1) {
    "use strict";
    var decorators;
    ...
    function addToString() {
        IoC.resolve("ILogger").error("Использование контентной опции компонента или шаблона в качестве строки", "Необходимо использовать контентные опции с помощью конструкции ws:partial или " +
