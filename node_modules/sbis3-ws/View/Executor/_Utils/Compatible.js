...
define("View/Executor/_Utils/Compatible", ["require", "exports", "Core/helpers/Function/shallowClone", "Core/IoC", "Core/constants", "View/Logger", "View/Executor/_Utils/OptionsResolver", "View/Executor/Expressions"], function (require, exports, shallowClone, IoC, constants, Logger, OptionsResolver_1, Expressions_1) {
    "use strict";
    ...
    function createCompoundControlNode(controlClass, controlCnstr, childrenNodes, userOptions, internalOptions, key, parentNode, virtualNode, markupGenerator) {
        var _deps = {}, moduleName = controlClass.prototype && controlClass.prototype._moduleName, markup;
