...
define("View/Executor/_Utils/Common", ["require", "exports", "Core/constants", "Core/RightsManager", "Core/helpers/Object/isPlainObject", "Core/IoC", "View/Executor/Expressions", "View/Executor/_Utils/RequireHelper"], function (require, exports, constants, RightsManager, isPlainObject, IoC, Expressions_1, RequireHelper) {
    "use strict";
    ...
    isNewObject = function isNewObject(scope) {
        ...
        if (isLibraryModuleString(tpl)) {
            ...
            var libPath = splitModule(tpl), library = _deps && _deps[libPath.library] || requireIfDefined(libPath.library);
    ...
    exports.isLibraryModuleString = isLibraryModuleString;
