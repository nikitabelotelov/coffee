...
define("View/Executor/_Utils/Vdom", ["require", "exports", "View/Request", "View/Logger", "View/Runner/Vdom/third-party/inferno", "View/Executor/Expressions", "View/Executor/_Utils/OptionsResolver", "View/Executor/_Utils/Common"], function (require, exports, Request, Logger, Inferno, Expressions_1, OptionsResolver_1, Common_1) {
    "use strict";
    ...
    function isVNodeType(vnode) {
        return vnode && (!Common_1.isString(vnode.children) && typeof vnode.children !== 'number') && vnode.hasOwnProperty('dom');
