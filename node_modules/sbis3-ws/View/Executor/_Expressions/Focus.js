...
define("View/Executor/_Expressions/Focus", ["require", "exports", "View/Executor/_Expressions/AttrHelper"], function (require, exports, AttrHelper_1) {
    "use strict";
    ...
    exports.prepareAttrsForFocus = prepareAttrsForFocus;
    ...
    function patchDom(dom, cfg) {
        dom = dom[0] ? dom[0] : dom;
        var attributes = dom.attributes, attrObj = {}, attrList = ['ws-delegates-focus',
            'ws-creates-context',
            'ws-autofocus',
            'tabindex',
            'ws-no-focus'
