...
define("View/Executor/_Expressions/ContextResolver", ["require", "exports", "Env/Env", "Core/DataContext"], function (require, exports, Env_1, DataContext) {
    "use strict";
            ...
            for (var i in ctx) {
                if (ctx.hasOwnProperty(i)) {
                    ...
                    if (ctx[i] && ctx[i]._moduleName && !whiteList[ctx[i]._moduleName]) {
                        Env_1.IoC.resolve('ILogger').error('Wrong context field', ctx[i]._moduleName
