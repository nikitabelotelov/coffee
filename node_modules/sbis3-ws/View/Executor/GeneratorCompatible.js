...
define("View/Executor/GeneratorCompatible", ["require", "exports", "Core/helpers/Number/randomId", "Core/Context", "Core/helpers/Hcontrol/configStorage", "Core/markup/ParserUtilities", "Core/core-extend-initializer", "Core/ContextBinder", "Env/Env", "Core/helpers/Function/shallowClone", "Core/Serializer", "View/Logger", "View/Request", "View/Executor/Markup", "View/Executor/Expressions", "View/Executor/Utils"], function (require, exports, randomId, Context, confStorage, ParserUtilities, coreInitializer, ContextBinder, Env_1, shallowClone, Serializer, Logger, Request, Markup_1, Expressions_1, Utils_1) {
    "use strict";
    ...
    function buildForNewControl(scope, cnstr, decOptions) {
        ...
        result = inst._template ? Markup_1.Generator.invisibleNodeCompat(inst.render(undefined, { attributes: decOptions })) : '';
