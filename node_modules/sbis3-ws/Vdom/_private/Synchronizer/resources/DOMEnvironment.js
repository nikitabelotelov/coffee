define("Vdom/_private/Synchronizer/resources/DOMEnvironment", ["require", "exports", "Env/Env", "Core/helpers/Array/findIndex", "Core/helpers/isNewEnvironment", "Vdom/_private/Synchronizer/resources/runDelayedRebuild", "Vdom/_private/Synchronizer/resources/VdomMarkup", "Vdom/_private/Synchronizer/resources/Hooks", "Vdom/_private/Synchronizer/resources/SyntheticEvent", "Vdom/_private/Synchronizer/resources/TabIndex", "View/Executor/Expressions", "View/Executor/Utils", "View/Executor/Markup", "Vdom/_private/Synchronizer/resources/Environment", "Vdom/_private/Synchronizer/resources/SwipeController", "View/Logger"], function (require, exports, Env_1, findIndex, isNewEnvironment, runDelayedRebuild_1, VdomMarkup_1, Hooks, SyntheticEvent_1, TabIndex, Expressions_1, Utils_1, Markup_1, Environment_1, SwipeController, Logger) {
    ...
    function domToVDom(dom) {
        ...
        function createFromElement(el) {
            ...
            return Markup_1.GeneratorVdom.createTag(tagName.toLowerCase(), props.properties, children, {
                ...
                if (!controlNode.control._mounted && !controlNode.control._unmounted) {
                    ...
                    try {
                        controlNode.control._afterUpdate &&
                            controlNode.control._afterUpdate(controlNode.oldOptions || controlNode.options, controlNode.oldContext);
                    }
                    catch (error) {
    ...
    function notifyActivationEvents(target, relatedTarget, isTabPressed) {
        var arrayMaker = goUpByControlTree(target), // Массив активированных компонентов
    ...
    proto._handleClick = function handleClick(event) {
         ...
         */
        var selection = window.getSelection ? window.getSelection() : null, hasSelection = selection && selection.toString().length && event.target.contains(selection.focusNode), userSelectIsNone = window.getComputedStyle
    ...
    proto._shouldUseClickByTap = function shouldUseClickByTap() {
        ...
        return (Env_1.constants.browser.retailOffline ||
            (Env_1.constants.compatibility.touch &&
                Env_1.constants.browser.chrome &&
                navigator &&
    ...
    function vdomEventBubbling(eventObject, controlNode, eventPropertiesStartId, args, native) {
        var eventProperties, stopPropagation = false, eventPropertyName = 'on:' + eventObject.type.toLowerCase(), curDomNode, fn, evArgs, res, templateArgs, finalArgs;
    ...
    function getEventPropertiesStartId(controlNode, eventName) {
        var eventProperties = controlNode.element.eventProperties, controlNodes = controlNode.element.controlNodes, handlerIdx = 0, nodeIdx = 0, eventPropertyName = 'on:' + eventName, beforeTarget = true, //true, пока не дошли до @controlNode в массиве controlNodes
    ...
    proto.startEvent = function (controlNode, args) {
        ...
        if (!eventConfig.target) {
            if (!(controlNode.fullMarkup instanceof Expressions_1.RawMarkupNode) &&
