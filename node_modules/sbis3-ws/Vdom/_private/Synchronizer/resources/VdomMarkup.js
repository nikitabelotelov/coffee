...
define("Vdom/_private/Synchronizer/resources/VdomMarkup", ["require", "exports", "Core/core-debug", "View/Executor/Utils", "Core/helpers/Array/flatten", "Vdom/_private/Utils/Monad", "Vdom/_private/Synchronizer/resources/Hooks"], function (require, exports, coreDebug, Utils_1, flatten, Monad_1, Hooks_1) {
    "use strict";
    ...
    function mapVNode(fn, controlNode, vnode, setHookToVNode, nodeArray, modify) {
        ...
        if (Utils_1.Vdom.isVNodeType(vnode)) {
            ...
            var newNodeArgs = fn(vnode.type, vnode.hprops, vnode.children, vnode.key, controlNode, vnode.ref, vnode), sameNode = vnode.type === newNodeArgs[0] &&
    ...
    function getFullMarkup(controlNodes, vnode, ignoreInnerComponent, currentFullMarkup, parentNode) {
        ...
        if (Utils_1.Vdom.isControlVNodeType(vnode)) {
        ...
        else if ((!Utils_1.Vdom.isTemplateVNodeType(vnode) && !Utils_1.Vdom.isVNodeType(vnode)) ||
            !vnode.children ||
            ...
            if (i === ln) {
                    ...
                    if (result.children && currentFullMarkup.children) {
                        if (result.children.length !== currentFullMarkup.children.length) {
                            ...
                            for (var chi = 0; chi < result.children.length; chi++) {
                                if (result.children[chi] !== currentFullMarkup.children[chi] ||
                ...
                if (currentFullMarkup) {
                    ...
                    if (!changed) {
                        if ((!currentFullMarkup.children && newChildren) ||
    ...
    function getDecoratedMarkup(controlNode, isRoot) {
        ...
        if (!Utils_1.Vdom.isControlVNodeType(result) &&
            !Utils_1.Vdom.isVNodeType(result) &&
            !Utils_1.Vdom.isTemplateVNodeType(result)) {
