...
define("Vdom/_private/Synchronizer/resources/TabIndex", ["require", "exports", "Vdom/_private/Utils/Functional"], function (require, exports, Functional_1) {
    "use strict";
    ...
    function getElementProps(element) {
        ...
        if (enabled) {
            ...
            result = {
                enabled: true,
                tabStop: (validTabIndex && tabIndex >= 0) ||
    ...
    function find(contextElement, fromElement, fromElementTabIndex, reverse, getElementProps) {
        Functional_1.assert(contextElement &&
        ...
        function canDelegate(next, nextProps) {
            ...
            return !!(!nextProps.delegateFocusToChildren ||
