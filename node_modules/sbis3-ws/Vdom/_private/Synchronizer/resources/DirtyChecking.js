    ...
    function getChangedOptions(newOptions, oldOptions, ignoreDirtyChecking, oldOptionsVersions, checkOldValue) {
        ...
        for (i in oldOptions) {
            ...
            if (hasOld) {
                ...
                if (hasNew) {
                    if ((typeof newOptions[i] === 'function' && typeof oldOptions[i] === 'function') ||
