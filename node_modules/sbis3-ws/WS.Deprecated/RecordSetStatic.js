   ...
   RecordSetStatic = RecordSet.extend(/** @lends Deprecated/RecordSetStatic.prototype */{
      ...
      endBatchAppend: function() {
         if (this._pocketAppending === true) {
            ...
            Env.IoC.resolve('ILogger').log("RecordSet:endBatchAppend", "Trying to complete batch processing, which is not started. Use beginBatchAppend before appendRecord.");
         }
      },
      /**
      ...
      setBigCalcSum: function (bigCalcSum){
         if (getType(bigCalcSum) == 'function') {
            ...
            Env.IoC.resolve('ILogger').error("RecordSet:setBigNumSum","Argument must be a function")
         }
      },
      /**
