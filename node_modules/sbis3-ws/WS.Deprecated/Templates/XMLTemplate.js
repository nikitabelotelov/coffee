define('Deprecated/Templates/XMLTemplate', [
...
], function(TransportOld, Env, Deferred, ParallelDeferred, core_attach, Context, CommandDispatcher, isEmptyObject, cInstance, randomId) {
   var XMLTemplate;
    ...
    * @extends Browser/TransportOld:Template
    * @author Бегунов А.В.
    * @public
    * @deprecated
    */
   XMLTemplate = TransportOld.Template.extend(/** @lends Deprecated/Templates/XMLTemplate.prototype */{
      /**
      ...
      _getIncludeDescriptorNodes: function() {
         ...
         if (this._xml.nodeType == TransportOld.nodeType.DOCUMENT_NODE) {
      ...
      _findCDATA: function(node, needValue) {
         ...
         for (var i = 0, l = node.childNodes.length; i < l; i++) {
            ...
            if (childNode.nodeType === TransportOld.nodeType.CDATA_SECTION_NODE) {
               ...
               if ((includeName = includeNodes[i].getAttribute('name')) !== null) {
                  if (this._innerTemplates[includeName]) {
                     ...
                     (function(parent, includeNode, i) {
                        dP.push(TransportOld.attachTemplate.loadTemplateFile(includeName).addCallback(function(xmlDoc) {
      ...
      createMarkup: function(container) {
         ...
         if (this._html === '') {
            ...
            while (col.length && i < col.length) {
               item = col.item(i);
               if (item.nodeType == TransportOld.nodeType.ELEMENT_NODE && item.nodeName != 'style') {
