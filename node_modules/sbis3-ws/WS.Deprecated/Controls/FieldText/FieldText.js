   ...
   var FieldText = FieldString.extend( /** @lends Deprecated/Controls/FieldText/FieldText.prototype */{
      ...
      _applyScrollClass: function() {
         ...
         if (area) {
            ...
            scrollHeight = Env.constants.browser.firefox ? area.scrollHeight - 1 : area.scrollHeight;
      ...
      setActive: function(active){
         ...
         if ((Env.constants.browser.isMacOSDesktop || Env.constants.browser.isIE) && active) {
            this._inputControl
               .focus()
               .val("")
               .val(this._curval);
      ...
      _keyboardHover: function(event){
         var key = event.which;
         if(event.shiftKey && key != Env.constants.key.up && key != Env.constants.key.down || event.altKey || event.ctrlKey) {
