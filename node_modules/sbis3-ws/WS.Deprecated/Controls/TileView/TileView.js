...
define('Deprecated/Controls/TileView/TileView',
   ...
   function(Env, HierarchyCustomView, dotTplForRow, DependencyResolver) {
      ...
      var TileView = HierarchyCustomView.extend(/** @lends Deprecated/Controls/TileView/TileView.prototype */{
         ...
         $protected: {
            _options: {
               ...
               iconWidth: Env.constants.Browser.iconWidth
            },
            _itemPercentage: {
         ...
         _keyboardHover: function(e) {
            ...
            if(this.isActive()) {
               if (e.which === Env.constants.key.left || e.which === Env.constants.key.right) {
                  var isKeyRight = e.which === Env.constants.key.right,
