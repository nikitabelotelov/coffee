define('Deprecated/Controls/TabControl/TabControl', [
   ...
   "html!Deprecated/Controls/TabControl/TabControl",
   "Deprecated/Controls/TabButtons/TabButtons",
   "Lib/Control/SwitchableArea/SwitchableArea",
   "css!Deprecated/Controls/TabControl/TabControl"
], function(
   collection,
   cDeferred,
   CompoundControl,
    ...
    *
    * @class Deprecated/Controls/TabControl/TabControl
    ...
    * @category Containers
    * @initial
    * <component data-component='Deprecated/Controls/TabControl/TabControl'>
    ...
    * @icon tabsIcon.png
    * @deprecated Используйте класс {@link SBIS3.CONTROLS/Tab/Control}.
    */
   var TabControl = CompoundControl.extend([HasItemsMixin], /** @lends Deprecated/Controls/TabControl/TabControl.prototype */{
      /**
      ...
      $protected: {
         _options: {
            /**
             * @cfg {SBIS3.CORE.TabControl/TabItem[]} Массив с закладками
             *
             * @example
             * <pre>
             *    <options name="items" type="array">
             ...
             *             <component data-component="Deprecated/Controls/FieldString/FieldString" style="width: 150px;" name="Корпуса">
             ...
             * @editorConfig displayFieldName title
             */
            defaultTab: '',
            randomId: randomId
         },
      ...
      $constructor: function() {
         ...
         this._options.items = collection(this._options.items);
         ...
         this.once('onInit', function(){
            ...
            this._tabButtons.subscribe('onTabChange', function(event, tabId, currentId) {
               ...
               event.setResult(self._setCurrentTabContent(ind));
      ...
      /**
       * Возвращает созданный компонент "Корешки закладок"
       * @returns {Deprecated/Controls/TabButtons/TabButtons}
       */
       ...
       * @return {dAddHelpers.collection} Коллекция элементов TabItem, содержащих информацию о закладке.
       * @see items
       */
      getItems: function() {
       ...
       * Происходит смена закладки в корешках, от контрола TabButtons идёт {@link Deprecated/Controls/TabButtons/TabButtons#onTabChange событие}, на которое подписан данный компонент закладок.
       * @param {String} id Идентификатор закладки.
       * @example
       * <pre>
       *     floatArea.subscribe('onBeforeShow', function() {
      ...
      setCurrentTab : function(id){
         return this._tabButtons.setCurrentTab(id || '') || new cDeferred().callback();
      },
      ...
      _setCurrentTabContent : function(index){
         ...
         result = this._switchableArea.setActiveArea(newTab.getId());
      ...
      setActive: function(active, isShiftKey) {
         TabControl.superclass.setActive.apply(this, arguments);
      ...
      /**
       * <a href='https://wi.sbis.ru/doc/platform/developmentapl/interfacedev/core/validation/'>Валидация</a> контролов в закладках.
       * @remark
      ...
      destroy: function(){
         ...
         TabControl.superclass.destroy.apply(this, arguments);
      }
   });
