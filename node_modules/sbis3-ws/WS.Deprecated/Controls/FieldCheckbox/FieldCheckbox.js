...
define("Deprecated/Controls/FieldCheckbox/FieldCheckbox", [
...
], function(CControl, Env, FieldAbstract, dotTplFn) {
   ...
   var FieldCheckbox = FieldAbstract.extend(/** @lends Deprecated/Controls/FieldCheckbox/FieldCheckbox.prototype */{
      ...
      _keyboardHover: function(event){
         if(event.which === Env.constants.key.space && this.isEnabled()){
            this._changeState();
         }
      },
         ...
         var self = this,
            checkValue = function(value){
               if (typeof value === 'boolean') {
                  ...
                  Env.IoC.resolve('ILogger').error('FieldCheckBox::_getDefaultValue', 'Incorrect default value ' + value);
               }
               return false;
            };
