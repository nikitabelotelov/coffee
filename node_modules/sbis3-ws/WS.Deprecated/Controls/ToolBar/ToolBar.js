   ...
   var ToolBar = AreaAbstract.extend(/** @lends Deprecated/Controls/ToolBar/ToolBar.prototype */{
      ...
      _addMenuButton: function(list) {
         ...
         list.push({
            ...
            image: (Env.constants.modules['WS.Deprecated'] ? Env.constants.resourceRoot + 'WS.Deprecated/' : Env.constants.wsRoot + 'deprecated') + '/Controls/ToolBar/resources/image/menu.png',
            handlers: {
      ...
      _showMenu: function() {
         if ((this._toolbarStyle === TBSTYLE_TRANSFER || this._toolbarStyle === TBSTYLE_DOCUMENT) && this._options.subMenuTemplate) {
            ...
            if (!this._menu) {
               ...
               offset.top -= this._toolbarStyle !== TBSTYLE_DEFAULT ? Env.constants.Toolbar.menuOffsetDocument.top : 0;
               if (this._toolbarStyle === TBSTYLE_DOCUMENT) { //Для стиля "документ" перекрываем тулбар контейнером меню
                  ...
                  offset.top += Env.constants.Toolbar.menuOffsetDefault.top;
               }
               this._menu.show(this._menuButton.children(),
                  this._toolbarStyle === TBSTYLE_DOCUMENT || (this._toolbarStyle === TBSTYLE_TRANSFER && this._container.hasClass('ws-toolbar__transfer-button-one')) ?
                     Env.constants.Toolbar.menuOffsetDocument :
                     this._toolbarStyle === TBSTYLE_TRANSFER ?
                        Env.constants.Toolbar.menuOffsetTransfer :
                        Env.constants.Toolbar.menuOffsetDefault, //Задаём оступы для разворота меню
      ...
      _buildMenu: function() {
         ...
         if ((this._toolbarStyle === TBSTYLE_TRANSFER || this._toolbarStyle === TBSTYLE_DOCUMENT) && this._options.subMenuTemplate) {
            ...
            this._toolbarMenuArea = new FloatArea({
               ...
               direction: 'left',
               side: 'right',
               offset: Env.constants.Toolbar.menuOffsetExtended,
               visible: false,
               handlers: {
                  onReady: function() {
      ...
      insertButton: function(config, position) {
         ...
         if (!config && Object.prototype.toString.call(config) !== '[object Object]') {
            Env.IoC.resolve('ILogger').log('Toolbar', 'element can not be created, because parameter "config" is undefined.');
            return;
         }
      ...
      getButton: function(id){
         ...
         try {
            ...
            Env.IoC.resolve('ILogger').log('Toolbar', 'element "' + id + '" is not present in this toolbar container.');
         }
         return result;
      },
      /**
      ...
      getButtonByName: function(name){
         ...
         try {
            ...
            Env.IoC.resolve('ILogger').log('Toolbar', 'element "' + name + '" is not present in this toolbar container.');
         }
         return result;
      },
      /**
