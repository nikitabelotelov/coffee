    ...
    */
      ...
      //Отключаем контрол пейджинг
         ...
         this._options.display.recordsPerPage = this._options.display.constantRecordsPerPage ?
            ...
            parseInt(($(window).height() / Env.constants.Browser.minHeight ) + 10 , 10);
      },
      /**
   ...
   */
      ...
      _onContainerScroll: function(event){
         var scrollTop = $(event.target).scrollTop(),
            ...
            check = this._loadingIndicator ? scrollTop + Env.constants.Browser.minHeight * 2 >= off : false;
      ...
      _onFAScroll: function(event, scrollOptions) {
         this._checkForLoad(scrollOptions.clientHeight + scrollOptions.scrollTop >= scrollOptions.scrollHeight - Env.constants.Browser.minHeight);
      },
