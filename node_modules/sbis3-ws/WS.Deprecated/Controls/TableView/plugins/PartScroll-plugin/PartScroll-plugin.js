...
define('Deprecated/Controls/TableView/plugins/PartScroll-plugin/PartScroll-plugin', [
   ...
   var TD_NOT_MOVABLE =
      (Env.constants.browser.firefox && navigator && parseInt(navigator.userAgent.split("Firefox/")[1]) < 37) ||
      (Env.constants.browser.isIE10 || Env.constants.browser.isIE12);
   ...
   TableView.PartScrollPlugin = TableView.extendPlugin(/** @lends Deprecated/Controls/TableView/plugins/PartScroll-plugin/PartScroll-plugin.prototype */{
      ...
      _initEvents: function() {
         ...
         this._thumbWrapper.bind('mousedown', function(e) {
            ...
            Env.constants.$body.addClass('ws-unSelectable');
            Env.constants.$doc.bind('mousemove.wsScrollMove', self._scrollMoveHandler.bind(self, startX));
            Env.constants.$doc.bind('mouseup.wsScrollMove', self._scrollMoveEnd.bind(self));
         });
      },
      /**
      ...
      _scrollMoveEnd: function() {
         ...
         Env.constants.$body.removeClass('ws-unSelectable');
         Env.constants.$doc.unbind('.wsScrollMove');
      },
      /**
