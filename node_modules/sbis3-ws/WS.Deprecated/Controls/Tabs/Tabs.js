...
define('Deprecated/Controls/Tabs/Tabs', [
   ...
   var Tabs = AreaAbstract.extend([HasTabsMixin], /** @lends Deprecated/Controls/Tabs/Tabs.prototype */{
      ...
      $constructor: function() {
         ...
         if (Env.constants.browser.isMobileSafari) this._button_active_classes += ' ws-tabs-button-active-ios-bg-hack';
      ...
      _initPosition : function(){
         ...
         if (this._options.showLabels) {
            if (this._options.position === 'left' || this._options.position === 'right') {
               if (!this._options.verticalText || Env.constants.browser.isIE) {
            ...
            this._scrollButtonsWidth = this._isScrollVertical ?
                                          ...
                                          Env.constants.Tabs.scrollButtonsVerticalTextHeight :
                                          Env.constants.Tabs.tabScrollButtonsHeight) :
                                       Env.constants.Tabs.scrollButtonsWidth;
         }
             ...
             scrollButtonsHeight = this._isScrollButtonsShowed ?
                                    (this._scrollButtonsWidth  +
                                       ((this._isScrollVertical && !this._options.verticalText && blockHeight < this._fullWidth) ?
                                        Env.constants.Tabs.tabScrollButtonsHeight : 0)) :
                                    0;
      ...
      _calculateFullWidth : function(){
         ...
         visibleCnt = this._forEachVisibleTabLabels(function(i, cnt) {
            ...
            if(this._options.verticalText && !Env.constants.browser.isIE){//Правим сглаживание шрифтов из-за нечётной ширины
      ...
      _animateHeader : function(marginValue){
         var self = this,
             update = function(){
                if(Math.abs(self._scrollToMargin - self._currentMargin) <= Env.constants.Tabs.animationLimit){
                   ...
                   self._currentMargin += Math.ceil((self._scrollToMargin - self._currentMargin) /
                         Env.constants.Tabs.animationSpeed);
                   if(self._currentMargin % 2 !== 0){
                      --self._currentMargin;
                   }
                   setTimeout(update, Env.constants.Tabs.animationTimer);
                }
      ...
      _setSideLabelsWidth : function(){
         ...
         for(i in this._scrollButtons){
            ...
            this._scrollButtons[i].width(maxWidth - Env.constants.Tabs.scrollButtonsBonusWidth);
         }
      ...
      _buildScrollButtons : function(){
         if(this._options.scrollable){
            ...
            for(var i in this._scrollButtonsDisabled){
               ...
               this._scrollButtons[i] = $('<div class="ws-hidden ws-tabs-scroll' + (this._scrollButtonsDisabled[i] ? '-disabled' : '') + ' ' + i + '"></div>')
                  ...
                  .css(side, ((this._options.verticalText) ?
                     (Env.constants.Tabs.verticalTextFirstScrollPadding) :
                     ((this._isScrollVertical && !this._options.verticalText) ? 0 :
                     (('right' == i) ? Env.constants.Tabs.firstHorizontalScrollButtonPadding :
                     Env.constants.Tabs.secondHorizontalScrollButtonPadding))))
                  .append($('<div class="ws-tabs-scroll-image ' + ((this._isScrollVertical) ?
                     (i === 'left' ? 'top' : 'bottom') :
                     i) + '"></div>')
                     .css('opacity', (this._scrollButtonsDisabled[i] ?
                        Env.constants.Tabs.scrollDisabledOpacity : Env.constants.Tabs.scrollEnabledOpacity)))
            ...
            this._scrollButtons['left'].css(posLeft, (this._options.verticalText ? Env.constants.Tabs.tabScrollButtonsHeight : 0) + 'px');
