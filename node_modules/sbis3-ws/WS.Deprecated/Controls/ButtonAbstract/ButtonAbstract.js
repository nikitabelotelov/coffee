...
define("Deprecated/Controls/ButtonAbstract/ButtonAbstract", [
...
], function(cInstance, forAliveOnly, processImagePath, cDeferred, CommandDispatcher, Env, Control ) {
   ...
   var ButtonAbstract = Control.DataBoundControl.extend(/** @lends Deprecated/Controls/ButtonAbstract/ButtonAbstract.prototype */{
      ...
      _keyboardHover: function(event){
         if (this.isEnabled()) {
            if (event.which == Env.constants.key.enter || event.which == Env.constants.key.space) {
               this._activate(event);
      ...
      _applyImageChange: function() {
         ...
         if(this._hasProcess){
            image = (Env.constants.modules['WS.Deprecated'] ? Env.constants.resourceRoot + 'WS.Deprecated/' : Env.constants.wsRoot + 'deprecated') + '/Controls/Button/resources/images/process.gif';
         }
         else{
