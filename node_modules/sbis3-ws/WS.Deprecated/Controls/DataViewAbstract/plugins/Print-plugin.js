...
define('Deprecated/Controls/DataViewAbstract/plugins/Print-plugin', [
    ...
    */
      ...
      $constructor: function(){
         ...
         this._reportPrinter = new TransportOld.ReportPrinter({ columns: this._columnMap, titleColumn: this._options.display.titleColumn});
         this._keysWeHandle[Env.constants.key.f4] = true;
         this._keysWeHandle[Env.constants.key.p] = true;
      ...
      _keyboardHover: function(e, res){
         ...
         if(this._printMenu !== null && this._printMenu.isShow()){
            ...
            needShowPrintMenu = e.which !== Env.constants.key.f4 && !(e.ctrlKey && e.which === Env.constants.key.p);
         }
         if(this.isActive() && !e.altKey && !e.shiftKey && ( !e.ctrlKey && e.which === Env.constants.key.f4 || (e.ctrlKey && e.which === Env.constants.key.p) )){
            if(needShowPrintMenu && (!ObjIsEmpty(this._options.reports || {}) && e.which === Env.constants.key.f4 || e.which !== Env.constants.key.f4)){
               this._showReportsList(e, e.which !== Env.constants.key.f4);
               return false;
            }
         }
         return res;
    ...
    */
      ...
      _saveToFile: function(options, idReport, data, isReportsForList) {
         ...
         if (fileType === 'PDF' || (fileType === 'EXCEL' && idReport !== undefined && !userSaveToExcelListMethod)) {
            ...
            xslDoc = new Env.IoC.resolve('IXMLDocument', {name: xsl}).getDocument();
            xmlDoc = TransportOld.RecordSetToXMLSerializer.serialize(data, rp.getColumns(), rp.getTitleColumn(), rootNode);
            ...
            xslDoc.addCallback(function (xslDocument) {
               ...
               if (columns instanceof Array) {
                  ...
                  xmlDoc = TransportOld.RecordSetToXMLSerializer.serialize(data, columns, rp.getTitleColumn(), rootNode);
               }
         ...
         var self = this,
            saveToFile = function () {
               cSaveToFile(object, methodName, params).addBoth(function(e){
                  ...
                  if (e && e.message) {
                     Env.IoC.resolve('ILogger').log( rk('Ошибка выгрузки в') + ' '  + object +': ' + e.message);
                  }
                  return e;
               });
            };
    ...
    */
      ...
      _getTransform: function(idReport, object, xsl, isReportsForList, fileType) {
         ...
         if (typeof idReport === 'undefined') {
            transform = Env.constants.wsRoot + 'res/xsl/' + xsl;
         } else {
            ...
            transform = Env.constants.resourceRoot + xsl;
         }
    ...
    */
      _showReport:function(idReport, object, xsl, isReportsForList){
         ...
         xmlDoc = TransportOld.RecordSetToXMLSerializer.serialize(object, rp.getColumns(), rp.getTitleColumn(), rootNode);
