define('Deprecated/Controls/DataViewAbstract/plugins/Move-plugin', [
   ...
   (function(){
      ...
      Env.constants.DataViewAbstractViewPlugin = {
         recordsMoveOffset: {
            left: 5,
            top: 5
         }
      ...
      DataViewAbstract.MovePlugin = DataViewAbstract.extendPlugin(/** @lends Deprecated/Controls/DataViewAbstract/plugins/Move-plugin.prototype */{
         ...
         $constructor: function(){
            ...
            this._keysWeHandle[Env.constants.key.m] = true;
            if (!this._options.display.readOnly && this._options.allowMove) {
               this._registerShortcut(Env.constants.key.m, Env.constants.modifiers.control, this.moveRecords);
               ...
               if (this.isTree()) {
                  this._registerShortcut(Env.constants.key.left, Env.constants.modifiers.shift, this._moveRecordsToParentOrChildren.bind(this, true));
                  this._registerShortcut(Env.constants.key.right, Env.constants.modifiers.shift, this._moveRecordsToParentOrChildren.bind(this, false));
               }
         ...
         _dragStart: function(target){
            ...
            for(var i = 0; i < target[0].childNodes.length; ++i){
               if(target[0].childNodes[i].nodeType == TransportOld.nodeType.TEXT_NODE){
                  textFound = true;
                  break;
               }
            }
