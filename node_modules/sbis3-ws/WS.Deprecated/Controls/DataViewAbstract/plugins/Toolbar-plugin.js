...
define('Deprecated/Controls/DataViewAbstract/plugins/Toolbar-plugin',
   ...
   "i18n!Deprecated/Controls/DataViewAbstract/plugins/Toolbar-plugin"
      ...
      function(CTreeView, CHierarchyView, cAttach, cInstance, cMerge, callBefore, cDeferred, cConstants, DataViewAbstract, Infobox, ToolBar) {
 ...
 DataViewAbstract.ToolbarPlugin = DataViewAbstract.extendPlugin(/** @lends Deprecated/Controls/DataViewAbstract/plugins/Toolbar-plugin.prototype */{
   ...
   _keyboardHover: function(e, controlResult){
      if(this.isActive()){
         ...
         if((this._isCtrl(e) && (e.which === cConstants.key.b || e.which === cConstants.key.v))){
            buttonId = this._turn !== "" ? (e.which === cConstants.key.b ? 'expandWithFolders' : 'expand') : 'clearExpand';
...
/*
   ...
   _prepareButton: function(button){
      return {
         tooltip: button[0],
         img: button[1] ? (button[1].search('sprite:') !== -1 ? button[1] : cConstants.wsRoot + button[1]) : '',
         name: button[2],
         handlers: {
   ...
   addToolbarButton : function(config, image, handlers, name, wsClassName){
      ...
      if (options.img && (options.img.indexOf(cConstants.resourceRoot) < 0 && options.img.indexOf(cConstants.wsRoot) < 0))
         options.img = cConstants.resourceRoot + options.img;
   ...
   _initActionsFlags: function(){
      ...
      this._actions['expandSet'] = this.isHierarchy() && !this._options.display.fixedExpand &&
            ...
            event.clientX = offset.left + cConstants.Toolbar.menuOffsetDefault.left;
            event.clientY = offset.top + cConstants.Toolbar.menuOffsetDefault.top + buttonContainer.height();
