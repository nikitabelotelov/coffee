define("Deprecated/Controls/SwitcherAbstract/SwitcherAbstract", [
   'Env/Env',
   "Lib/Control/Control",
   "css!Deprecated/Controls/SwitcherAbstract/SwitcherAbstract"
    ...
    *
    * @class Deprecated/Controls/SwitcherAbstract/SwitcherAbstract
    * @public
    * @author Крайнов Д.О.
    * @extends SBIS3.CORE.DataBoundControl
    * @deprecated
    */
   var SwitcherAbstract = Control.DataBoundControl.extend(/** @lends Deprecated/Controls/SwitcherAbstract/SwitcherAbstract.prototype */{
      /**
      ...
      $protected: {
         _options: {
            /**
             * @cfg {Boolean|Function} Значение переключателя
             * Начальное значение. Если передать функцию, то будет использовать возвращаемое из функции значение как начальное.
             */
            value: false,
            /**
             * @cfg {String} Текст в "выключенном" состоянии.
             * @translatable
             */
            textOff: '',
            /**
             * @cfg {String} Текст в "включённом" состоянии.
             * @translatable
             */
            textOn: '',
      ...
      _setEnabled: function(enable){
         SwitcherAbstract.superclass._setEnabled.apply(this, arguments);
      },
      /**
       ...
       */
      _initKeys: function(){
         this._keysCallbackMap[Env.constants.key.space] = this._toggleByUser;
         this._keysCallbackMap[Env.constants.key.left] = this._keyLeft;
         this._keysCallbackMap[Env.constants.key.right] = this._keyRight;
      },
      /**
