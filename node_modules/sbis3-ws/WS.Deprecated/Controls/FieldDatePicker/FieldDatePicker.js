 ...
 */
define('Deprecated/Controls/FieldDatePicker/FieldDatePicker', [
   "Core/Deferred",
   'Core/moduleStubs',
   'Core/core-ready',
   "Lib/Control/Control",
   "html!Deprecated/Controls/FieldDatePicker/FieldDatePicker",
   "html!Deprecated/Controls/FieldDatePicker/FieldDatePicker-legend",
   "css!Deprecated/Controls/FieldDatePicker/FieldDatePicker"
], function(
   cDeferred,
   moduleStubs,
   cReady,
   ...
   var showDatePicker = function (id, func, firstDayToShow) {
      var def = new Deferred();
      cReady.addCallback(function () {
         moduleStubs.require(["/cdn/jquery-ui/1.8.5/jquery-ui-p2.min.js",
            "css!/cdn/jquery-ui/1.8.5/jquery-ui-p2.min.css",
            "Deprecated/Controls/FieldDate/resources/ext/jquery.ui.datepicker-local"])
   ...
   /**
    * @class Deprecated/Controls/FieldDatePicker/FieldDatePicker
    ...
    */
   var FieldDatePicker = Control.DataBoundControl.extend(/** @lends Deprecated/Controls/FieldDatePicker/FieldDatePicker.prototype */{
      /**
       ...
       * @param {Env/Event:Object} eventObject Дескриптор события описание в классе Core/Abstract
       ...
       *         CoreFunctions.alert("Вы выбрали праздничный день!");
       *   });
       * </pre>
       */
      /**
       ...
       * @param {Env/Event:Object} eventObject Десриптор события описание в классе Core/Abstract
       * @example
       * <pre>
      ...
      $protected:{
         ...
         _objData : null,
         _defferedShowDatePicker: new cDeferred(),
         _rangeSelectStep: 0,
      ...
      $constructor:function () {
         ...
         if (this._isCorrectContainer()) {
            ...
            this._defferedShowDatePicker = showDatePicker(this.getContainer(), this._options.dateRenderFunction, self._parseToDate(firstDay));
      ...
      onInit : function(){
         ...
         this._defferedShowDatePicker.addCallback(function () {
            ...
            // Независимо от локали получаем дату в одинаковом формате
            $(self.idDiv).datepicker( "option", "dateFormat", 'dd.mm.yy');
            ...
            var highLight = self._notify('onHighlight'),
                  legend;
            if (highLight instanceof cDeferred) {
            ...
            if (legend instanceof cDeferred) {
