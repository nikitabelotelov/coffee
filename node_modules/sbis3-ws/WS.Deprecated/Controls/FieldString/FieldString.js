...
define('Deprecated/Controls/FieldString/FieldString', [
   ...
   var FieldString = FieldAbstract.extend(/** @lends Deprecated/Controls/FieldString/FieldString.prototype */{
      ...
      _initEvents: function() {
         ...
         if (!Env.constants.compatibility.placeholder && inputControl.is('input')) {
            setTimeout(function() {
         ...
         inputControl.bind('keypress', function(event) {
            ...
            if (Env.constants.browser.isIE && self._inputControl.attr('type') == 'text') {
               e.preventDefault();
            ...
            if (Env.constants.browser.isMobileSafari) {
                ...
                */
               setTimeout(function (){
                  var scroll = Env.constants.$win.scrollTop(),
                  ...
                  if (bcr.bottom > window.innerHeight*koef) {
                      ...
                      */
                     Env.constants.$win.scrollTop(scroll + Math.round(window.innerHeight*koef)/2 + Math.abs(Math.round(window.innerHeight*koef) - bcr.bottom));
                  }
               }, 50);
            }
      ...
      */
      ...
      _tooltipHandler: function() {
         if (this.isTooltipInside() && this._options.tooltip.length > 0 && !Env.constants.compatibility.placeholder) {
      ...
      _setTooltipInside: function(tooltip) {
         if (tooltip && typeof tooltip === 'string') {
            if (Env.constants.compatibility.placeholder) {
      ...
      setMaxLength: function (maxLen){
         ...
         if(Env.constants.browser.firefox && !isElementVisible(this._inputControl)) {
      ...
      _updateInPlaceValue: function (value) {
         if (this._editAtPlace && this.isPassword() && this._editAtPlaceElement) {
            value = value.replace(/./g, Env.constants.browser.webkit ? String.fromCharCode(8226) : String.fromCharCode(9679));
