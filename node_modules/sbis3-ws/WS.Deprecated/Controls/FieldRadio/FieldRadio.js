 ...
 */
define('Deprecated/Controls/FieldRadio/FieldRadio',
      [
   ...
   "html!Deprecated/Controls/FieldRadio/FieldRadio",
   "Deprecated/Controls/FieldString/FieldString",
   "is!browser?/cdn/jquery-ui/1.8.5/jquery-ui-p2.min.js",
   "browser!Deprecated/Controls/FieldRadio/resources/ext/ui.checkbox",
   "css!Deprecated/Controls/FieldRadio/FieldRadio",
   "i18n!Deprecated/Controls/FieldRadio/FieldRadio"
],
      function(getType, Env, dEnum, FieldAbstract, Infobox, dotTplFn) {
    ...
    *
    * @class Deprecated/Controls/FieldRadio/FieldRadio
    * @extends Deprecated/Controls/FieldAbstract/FieldAbstract
    * @author Крайнов Д.О.
    * @control
    * @public
    * @category Select
    * @designTime plugin Deprecated/Controls/FieldRadio/design/DesignPlugin
    * @ignoreOptions width
    * @ignoreOptions maxLength
    * @initial
    * <component data-component='Deprecated/Controls/FieldRadio/FieldRadio'>
    ...
    *    <option name='value'>Радиокнопка1</option>
    * </component>
    * @deprecated Используйте класс {@link SBIS3.CONTROLS/Radio/Group}.
    */
   var FieldRadio = FieldAbstract.extend(/** @lends Deprecated/Controls/FieldRadio/FieldRadio.prototype */{
      $protected: {
         _options: {
            /**
             ...
             * @see buttonDirection
             * @see columnsCount
             * @variant horizontal горизонтальное расположение, при котором радиокнопки строятся строкой
             * @variant vertical вертикальное расположение, при котором кнопки формируют столбцы. Количество столбцов определяется значением опции {@link columnsCount}
             * @variant horizontalSwitcher горизонтальный переключатель - выстраиваются строкой и активная радиокнопка выделена овальной рамкой
             * @group Display
             */
            mode: 'vertical',
            /**
             ...
             * @variant left выравнивание по левому краю
             * @variant right выравнивание по правому краю
             * @group Display
             */
            textAlign: 'left',
            autoHeight: false,
            /**
             * @cfg {Function(SBSI3.CORE.FieldRadio.Data): jQuery} Функция отрисовки строки
             *
      ...
      $constructor : function(){
         ...
         this._initRadio();
         if (parent) {
            this.subscribeTo(parent, 'onResize', this._calcWidthBound).
                 subscribeTo(parent, 'onActivate', this._calcWidthBound);

            if(parent.hasEvent('onAfterShow')) {
               this.subscribeTo(parent, 'onAfterShow', this._calcWidthBound);
            }
         } else {
      ...
      _initRadio: function(){
         var
            self = this,
            radioStrBlocks = this._container.find('.radioStr').toArray();
         for (var i in radioStrBlocks) {
            if (radioStrBlocks.hasOwnProperty(i)) {
               var
                  elem = radioStrBlocks[i]
               ...
               elem.bind('mouseenter', function () {
                  ...
                  Infobox.show(elem, self._options.data[i].extendedTooltip, 'auto',  Infobox.SHOW_TIMEOUT,  Infobox.ACT_CTRL_HIDE_TIMEOUT, function(){
      ...
      _initConfig: function() {
         ...
         FieldRadio.superclass._initConfig.apply(this, arguments);
         if (!mode) {
      ...
      destroy : function(){
         ...
         FieldRadio.superclass.destroy.apply(this, arguments);
      },
      /**
      ...
      _createEnum : function(){
         ...
         if (!this.getValidators().length) {
            this._options.validators = [{
               ...
               errorMessage: rk('Поле обязательно для заполнения')
            }];
         }
         return new dEnum({
      ...
      setValue : function(value, ignoreReadonly, noRevalidate){
          var newValue = value instanceof dEnum ? value.clone() : value;
          FieldRadio.superclass.setValue.apply(this, [newValue, ignoreReadonly, noRevalidate]);
      },
      _curValue : function(){
      ...
      _setValueInternal : function(val){
         ...
         if (enumObject instanceof dEnum) {
            var
               self = this,
            ...
            this._inputControl.each(function () {
               if ($(this).find('input').val() == value && !$(this).is(':checked'))
                  self._curRadio = $(this).find('input').prop('checked', true);
            });
       ...
       * @returns {dEnum} Возвращается копия Enum'а вместо оригинала.
       * @example
      ...
      _getEnumWithIndex: function(index){
         ...
         try{
            ...
            Env.IoC.resolve('ILogger').error('FieldRadio', e.message);
            return undefined;
         }
      },
      /**
      ...
      _getEnumWithValue: function(value){
         ...
         Env.IoC.resolve('ILogger').error('FieldRadio', 'Connot set value by name "' + value + '"');
         return undefined;
      },
      /**
       *
