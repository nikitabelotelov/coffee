   ...
   var SearchString = FieldString.extend(/** @lends Deprecated/Controls/SearchString/SearchString.prototype */{
      ...
      _keyPressedHandler: function(eventObject, e) {
         ...
         if (e.which === cConstants.key.enter) {
            ...
            isKeyUp = e.which === cConstants.key.up;
            isKeyLeft = e.which === cConstants.key.left;
            ...
            if (e.which === cConstants.key.down || isKeyUp) {
            ...
            if (this._currentBrowser.isTree() && (e.which === cConstants.key.right || isKeyLeft)) {
