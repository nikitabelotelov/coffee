define("Deprecated/Controls/DragAndDropPlugin/DragAndDropPlugin", [
   ...
   Env.constants.DragAndDropPlugin = {
      recordsMoveOffset: {
         top: 5,
         left: 5
      }
   ...
   CControl.Control.DragAndDropPlugin = /** @lends Deprecated/Controls/DragAndDropPlugin/DragAndDropPlugin.prototype */{
      ...
      _addDragContainer: function(selector, container){
         container.on('mousedown', selector, function(event){
            ...
            Env.constants.$doc.bind('mousemove.wsDragNDrop', this._dragMouseMove.bind(this))
                           .bind('mouseup.wsDragNDrop', this._dragMouseUp.bind(this));
            Env.constants.$win.bind('blur', this._dragCancel.bind(this));
      ...
      _createDragObject: function(event){
         ...
         return $('<div class="ws-dragged"><span class="ws-dragged-count">' +
            ...
            '</span></div>')
            .css({
               'left': event.clientX + Env.constants.DragAndDropPlugin.recordsMoveOffset.left,
               'top': event.clientY + Env.constants.DragAndDropPlugin.recordsMoveOffset.top
            });
      },
      /**
      ...
      _checkDragDistance: function(event){
         if( !this._drag.started ){
            ...
            if( changeX + changeY > Env.constants.startDragDistance ){
      ...
      _dragMouseMove: function(event){
         ...
         this._drag.flowObject.css({
            'left': event.pageX + Env.constants.DragAndDropPlugin.recordsMoveOffset.left,
            'top': event.pageY + Env.constants.DragAndDropPlugin.recordsMoveOffset.top
         });
