 ...
 */
define("Deprecated/Controls/Switcher/Switcher", [
   'Env/Env',
   "Deprecated/Controls/SwitcherAbstract/SwitcherAbstract",
   "html!Deprecated/Controls/Switcher/Switcher"
], function(
   Env,
   SwitcherAbstract,
   dotTplFn
   ...
   /**
    * @class Deprecated/Controls/Switcher/Switcher
    * @extends Deprecated/Controls/SwitcherAbstract/SwitcherAbstract
    * @author Крайнов Д.О.
    * @control
    * @public
    * @category Select
    * @initial
    * <component data-component='Deprecated/Controls/Switcher/Switcher' style='width: 100px'>
    *    <option name='textOn'>On</option>
    *    <option name='textOff'>Off</option>
    *    <option name='width'>100px</option>
    * </component>
    * @designTime plugin Deprecated/Controls/Switcher/design/DesignPlugin
    * @deprecated Используйте класс {@link SBIS3.CONTROLS/Switcher}.
    */
   var Switcher = SwitcherAbstract.extend(/** @lends Deprecated/Controls/Switcher/Switcher.prototype */{
      $protected: {
         _options: {
            /**
      ...
      $constructor: function(){
         if( Env.constants.browser.isIE7 ){
      ...
      _onClickHandler: function(){
         Switcher.superclass._onClickHandler.apply(this, arguments);
         if( this.isEnabled() ){
            this._toggleByUser();
         }
      },
      ...
      _setEnabled: function(enable){
         Switcher.superclass._setEnabled.apply(this, arguments);
