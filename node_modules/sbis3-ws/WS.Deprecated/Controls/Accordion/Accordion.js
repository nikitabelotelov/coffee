 ...
 */
define('Deprecated/Controls/Accordion/Accordion', [
   "Deprecated/core-attach",
   "Core/core-instance",
   "Core/Deferred",
   "Lib/Control/Control",
   "Core/DependencyResolver",
   "html!Deprecated/Controls/Accordion/Accordion",
   "html!Deprecated/Controls/Accordion/Accordion_element",
   "Core/helpers/vital/processImagePath",
   "css!Deprecated/Controls/Accordion/Accordion"
],function(cAttach, cInstance, cDeferred, control, DependencyResolver, dotTplFn, elementTplFn, processImagePath ) {

   'use strict';

   DependencyResolver.register('Deprecated/Controls/Accordion/Accordion', function(config){
      return config.isCollapsing ? ['Deprecated/Controls/Accordion/plugins/Collapse-plugin'] : [];
   });
    ...
    * @class Deprecated/Controls/Accordion/Accordion
    * @author Крайнов Д.О.
    ...
    * @category Navigation
    * @initial
    * <component data-component='Deprecated/Controls/Accordion/Accordion'>
    ...
    * @deprecated Используйте класс {@link SBIS3.CONTROLS/Accordion}.
    */
   var Accordion = control.Control.extend(/** @lends Deprecated/Controls/Accordion/Accordion.prototype */{
      /**
       * @cfg {Boolean} Сохранять состояние
       * @name Deprecated/Controls/Accordion/Accordion#saveState
       * @description
       ...
       * @remark
       * Событие происходит после открытия группы. При этом не гарантируется готовность контролов, находящихся в контенте группы.
      ...
      $protected: {
         _options : {
             ...
             *
             * @remark
             * Опция позволяет задать загрузку всех групп при инициализации аккордеона.
             * Группы загружаются параллельно.
             * После каждой загрузки группы происходит событие {@link onGroupContentLoaded}.
             * Количество групп определяет число событий.
             ...
             *       image: 'sprite:icon-16 icon-Arrow1730 icon-primary'
             *    }];
             * </pre>
             * @see appendFlags
             * @group Groups
      ...
      _showElementWrapper: function(element) {
        ...
        * Смотреть подробнее в {@link Lib/NavigationController/NavigationController}.
        * @example
      ...
      closeElement : function(id, resize){
        ...
        *    b) {@link cDeferred}. Группа откроется, если данный deferred возвращает true.
        *    </li>
      ...
      openElement : function(id, resize, notifyOnClick, changeState){
         ...
         var
            ...
            openResult = new cDeferred(),
            handlerResult;

         if (element !== undefined){
            handlerResult = self._notify('onBeforeGroupOpen', id);
            if (handlerResult instanceof cDeferred){
      ...
      _openElement : function(id, element, resize, notifyOnClick, changeState){
         ...
         if (!element.dReady && element.template){
            ...
            if (element.dReady instanceof cDeferred){
       ...
       * @param {String} id Идентификатор группы.
       * @returns {Lib/Control/TemplatedArea/TemplatedArea|undefined} Возвращает класс открытой группы.
       ...
       *    accordion.subscribe('onLabelClick', function(eventObject, id) {
       *       var label = this.getLabelById(id);
       *       Marker.positionToElement(label);
       *    });
       * </pre>
       * @see elements
       * @see enableLable
      ...
      isGroupLoaded : function(id){
         return (this._elements[id].dReady instanceof cDeferred) && this._elements[id].dReady.isReady();
      },
      destroy : function(){
         ...
         Accordion.superclass.destroy.apply(this, arguments);
      },
      /**
      ...
      _loadToolbar : function(id){
         ...
         return cAttach.attachInstance('Deprecated/Controls/ToolBar/ToolBar', config);
      },
      /**
      ...
      _loadTemplate : function(id, notifyOnClick, changeState){
         ...
         element.dReady = new cDeferred();

         this._runInBatchUpdate('_loadTemplate - Accordion', function() {
            return cAttach.attachInstance('Lib/Control/TemplatedArea/TemplatedArea', {
         ...
         for (var j in this._elements){
            if (this._elements.hasOwnProperty(j)){
               var
                  ...
                  hasSpaces = label.text().trim().indexOf(" ")>-1;
      ...
      _onResizeHandler:function(){
         ...
         // вызов обработчика родителя(Lib/Control/Control), чтобы центровать при максимальных размерах
         Accordion.superclass._onResizeHandler.apply(this, arguments);
      },
      /**
      ...
      _setGroupSize : function(id){
         if (this._elements && this._elements[id]){
            var element = this._elements[id];
            if (element && cInstance.instanceOfModule(element.instance, 'Lib/Control/TemplatedArea/TemplatedArea'))
