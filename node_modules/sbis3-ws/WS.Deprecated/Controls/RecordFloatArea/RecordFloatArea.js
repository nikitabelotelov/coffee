...
define('Deprecated/Controls/RecordFloatArea/RecordFloatArea', [
   ...
   var RecordFloatArea = FloatArea.extend(/** @lends Deprecated/Controls/RecordFloatArea/RecordFloatArea.prototype */{
       ...
       * @param {Env/Event:Object} eventObject
      ...
      $constructor: function(){
         ...
         if(this.getReports().length !== 0) {
            this._reportPrinter = new TransportOld.ReportPrinter({});
         }
               ...
               if (!destroyed && focusedControl)
               {
                  ...
                  else if (self.isVisible() && self.isAutoHide() && self._shouldHideByFocusMoveTo(focusedControl))
                  {
                     ...
                     if (!self._isClosed && self._state !== 'hide' &&
                         ...
                         topParent !== self &&
                         !self._isFocusOnConfirmation(event.getTarget()))
                     {
                        var
      ...
      _isFocusOnConfirmation: function(target) {
         if (target) {
            var container = target.getContainer();
            var isConfirmation = container.closest('.controls-InformationPopup').length;
      ...
      destroy: function(){
         ...
         EnvEvent.Bus.channel('navigation').unsubscribe('onBeforeNavigate', this._onBeforeNavigate, this);
