define('Deprecated/RecordSet', [
    ...
    *           });
      ...
      _buildHierarchyData: function(data) {
         ...
         if (recursive) {
            Env.IoC.resolve('ILogger').error("RecordSet", "Recursive hierarchy data");
         }
      ...
      readRecord: function(id, filter, linkName) {
         if (id === undefined) {
            Env.IoC.resolve('ILogger').log("RecordSet", "It is not recommended to use readRecord with id === undefined, use createRecord.");
    ...
    *     })
      ...
      appendRecord: function(data, noConfirm, noBuildHierarchy, usePkColumn) {
         ...
         if (data instanceof Record) {
            ...
            Env.IoC.resolve('ILogger').log("RecordSet:appendRecord", "Deprecated call of method with arguments type Object. Use Deprecated/Record");
            row = [];
            for (var i = 0; i < len; i++) {
               colDef = columns[i];
