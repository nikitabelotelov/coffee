define('Deprecated/xslt', [
   ...
   var XSLTransform = coreExtend.extend({}, /** @lends Deprecated/XSLTransform.prototype */{
      ...
      $constructor: function() {
         Env.IoC.resolve('ILogger').info('Deprecated', 'В 3.7.4.230 синхронная работа с xslt будет прекращена. Используйте Core/xslt-async');
      ...
      _loadDoc: function(doc) {
         if(this._loadedFiles.indexOf(doc) == -1) {
            ...
            Env.IoC.resolve('ILogger').log('XSLTransfor', 'Potential cyclic dependency on file ' + doc);
            return null;
         }
      },
      /**
   ...
   var XMLDocument = function(config) {
      return Env.IoC.resolve('IXMLDocumentSync', config);
   };
   ...
   Env.constants.XSLTCaps = Env.constants.XSLTCaps || XSLTCaps;
   Env.IoC.bind('IXMLDocumentSync', ClientXMLDocument);
