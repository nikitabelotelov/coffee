define('Deprecated/BLObject', [
...
], function(coreExtend, Deferred, Env, Transport, SerializatorSBIS, RecordSet, cInstance, newRecordSet) {
   var BLObject;
   ...
   BLObject = function(config) {
      ...
      return Env.IoC.resolve('IBLObject', config);
      }
   };
    ...
    * @author Зуев Д.В.
    * @public
    * @deprecated Используйте класс {@link Types/source}.
    */
      ...
      call: function(method, args, type, hierarchyField, updateMethod, destroyMethod) {
         ...
         switch (type) {
            ...
            case BLObject.RETURN_TYPE_ASIS:
               ...
               return new Transport.RPCJSON({serviceUrl: this._serviceUrl}).callMethod(this._name + '.' + method, tmp);
            default:
   ...
   Env.IoC.bind('IBLObject' ,ClientBLObject)
   return BLObject;
});
