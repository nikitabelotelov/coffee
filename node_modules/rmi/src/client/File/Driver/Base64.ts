...
export default class Base64Driver implements FileDriver {
    ...
    public download(fileParams?: FileParams): Promise<void | Error> {
        ...
        if (typeof window !== 'undefined' && detection.isMobileSafari && detection.IOSVersion >= 12) {
            windowOpen(`${BASE64_PREFIX(type)}${this.base64Data}`, {
        ...
        try {
            ...
            return Promise.reject(new Error(`
                Ошибка конвертации Base64 строки ${this.base64Data} в Blob!
                ${e.message}`
            ));
        }
