...
// @ts-ignore
import { provider as TypeProvider } from "Types/source";
// @ts-ignore
...
const SbisBusinessLogic = TypeProvider.SbisBusinessLogic;
 ...
 * @extends Types/source.provider.SbisBusinessLogic
 */
...
register('source.provider.file-abstract', Abstract);
