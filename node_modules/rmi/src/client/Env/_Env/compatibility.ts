/// <amd-module name="Env/_Env/compatibility" />
import 'Env/_Env/bomDefine';
...
export = {
    ...
    /**
     * Поддержка загрузки файлов с использованием стандартного инпута
     * (её может не быть, если, к примеру, у пользователя iPad)
     */
    ...
    /**
     * Поддержка <b>requestFullscreen</b> и подобных на элементе
     * (позволяет показывать в полноэкранном режиме только некоторые элементы)
     */
    fullScreen: document && (
     ...
     * 2) 'mousewheel'. Старое, популярное событие.
     * Имеет большие проблемы из-за разных значений в различных браузерах и даже ос.
     * Аналог в файерфоксе - MozMousePixelScroll или DOMMouseWheel.
    ...
    /**
     * Поддержка css-трансформаций. Появились в Chrome (изначально),
     * Firefox (3.5), Internet Explorer (9), Opera (10.5), Safari (3.1)
     */
