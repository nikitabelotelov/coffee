...
import { Subscribe } from 'Browser/_Event/Server/worker/subscribe';
import { SubscribeController } from 'Browser/_Event/Server/worker/subscribe-controller';
import WorkerStompConnect = require('Browser/_Event/Server/worker/stomp-connect.worker');
