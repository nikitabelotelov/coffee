/// <amd-module name="Browser/_Transport/RPCJSON" />
// @ts-ignore
...
import request from 'Browser/_Transport/RPC/request';
import fallback from 'Browser/_Transport/RPC/fallback';
import * as ErrorCreator from 'Browser/_Transport/RPC/ErrorCreator';
import 'Browser/_Transport/XHR';
...
var RPCJSON = coreExtend({}, /** @lends Transport/RPCJSON.prototype */ {
  ...
  /// region deprecated private
   ...
   _setHeaders: function(req, httpMethod, recent) {
       deprecatedLog('_setHeaders', 'Browser/_Transport/RPC/Headers');
       // @ts-ignore
...
RPCJSON.getEmptyRpcResponse = deprecatedWrapper(
   "getEmptyRpcResponse",
   "Browser/_Transport/RPC/Body#getEmptyResponse",
...
RPCJSON.handleHTTPError = deprecatedWrapper(
   "handleHTTPError",
   "Browser/_Transport/RPC/ErrorNotifier#HTTP",
...
RPCJSON.handleRPCError = deprecatedWrapper(
   "handleRPCError",
   "Browser/_Transport/RPC/ErrorNotifier#RPC",
   ErrorCreator.fromRPC
);

/// endregion deprecated static

export default RPCJSON;
