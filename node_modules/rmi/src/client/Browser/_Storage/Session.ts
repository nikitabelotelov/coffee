/// <amd-module name="Browser/_Storage/Session" />
// @ts-ignore
import * as UserInfo from 'Core/UserInfo';
import { detection } from 'Env/Env';
import { constants }  from 'Env/Constants';
import { getSession } from 'Browser/_Storage/_storage';

var saveSSTimeout;
var storage = getSession();
...
* @public
*/
let SessionStorage = /** @lends Core/SessionStorage.prototype */{
  get: function(key) {
